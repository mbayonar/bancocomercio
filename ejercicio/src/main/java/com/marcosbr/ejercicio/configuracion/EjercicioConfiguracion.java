package com.marcosbr.ejercicio.configuracion;
...
@EntityScan(basePackages = {"com.marcosbr.ejercicio.entidad"})
...
public class EjercicioConfiguracion {
    ...
    public LocalSessionFactoryBean sessionFactory() throws Exception {
        ...
        bean.setPackagesToScan("com.marcosbr.ejercicio.entidad");
